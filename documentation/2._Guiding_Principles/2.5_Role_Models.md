...
In a data space multiple service providers can offer [optional capabilities](../3._Functional_Requirements/3.9_Observability.md#optional-functions)
...
section](../3._Functional_Requirements/3.3_Establishing_trust.md#policies) and in the [DSSC Blueprint Version 1](http://dssc.eu).
