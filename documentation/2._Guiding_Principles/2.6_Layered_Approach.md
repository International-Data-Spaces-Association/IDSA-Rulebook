...
In line with the description of the [role models](2.5_Role_Models.md) and the [layered approach](#layers-of-a-data-space), the diagram below presents an overview on roles in data spaces and their affilation to the layers.
