...
The [functional requirements](../3._Functional_Requirements/3.3_Establishing_trust.md#policies)  section explains how such a framework needs to be translated into
