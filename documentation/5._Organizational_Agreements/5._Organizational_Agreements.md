...
mechanisms in [Chapter 3](../3.%20Functional_Requirements/). This chapter discusses the operational
implications using IDS Certification as an example.

[Chapter 3](../3.%20Functional_Requirements/) mentions two important aspects: The first is the data space
...
facilities are provided in [Chapter 4](../4.%20Technical_Agreements/).
